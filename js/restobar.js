...
function showNav() {
  document.querySelector(".main-navigation-two").innerHTML = "";
    ...
    <div class="main-nav-head">
      <div class="nav-head">
        <div class="header ">
          ...
          <p class="face-insta text-white  "><a href=""><i class="fa-brands fa-facebook-f"></i> </i></a>
...
`;
  ...
  document.querySelector(".main-navigation-two").append(container);
}
